 ...
 */
final class Version20220217210003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD advisor_id INT DEFAULT NULL');
