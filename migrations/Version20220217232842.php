 ...
 */
final class Version20220217232842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modify_profil ADD type_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_CF7D3D24C54C8C93 ON modify_profil (type_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CF7D3D24C54C8C93 ON modify_profil');
        $this->addSql('ALTER TABLE modify_profil DROP type_id, CHANGE token token VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE data data VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
