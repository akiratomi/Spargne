 ...
 */
final class Version20220217234113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE modify_profil ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE modify_profil ADD CONSTRAINT FK_CF7D3D24A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('CREATE INDEX IDX_CF7D3D24A76ED395 ON modify_profil (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CF7D3D24A76ED395 ON modify_profil');
        $this->addSql('ALTER TABLE modify_profil DROP user_id, CHANGE token token VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE data data VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
