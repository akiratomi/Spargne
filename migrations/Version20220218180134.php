 ...
 */
final class Version20220218180134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD first_mdp TINYINT(1) NOT NULL');
    }
