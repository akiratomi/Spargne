 ...
 */
final class Version20220222145833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transferts ADD type_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE transferts ADD CONSTRAINT FK_47A3EBA3C54C8C93 FOREIGN KEY (type_id) REFERENCES transferts_type (id)');
        $this->addSql('CREATE INDEX IDX_47A3EBA3C54C8C93 ON transferts (type_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_47A3EBA3C54C8C93 ON transferts');
        $this->addSql('ALTER TABLE transferts DROP type_id');
