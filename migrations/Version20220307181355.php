 ...
 */
final class Version20220307181355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card ADD account_id INT NOT NULL');
        $this->addSql('ALTER TABLE card ADD CONSTRAINT FK_161498D39B6B5FBA FOREIGN KEY (account_id) REFERENCES `account` (id)');
        $this->addSql('CREATE INDEX IDX_161498D39B6B5FBA ON card (account_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE card DROP FOREIGN KEY FK_161498D39B6B5FBA');
        $this->addSql('DROP INDEX IDX_161498D39B6B5FBA ON card');
        $this->addSql('ALTER TABLE card DROP account_id, CHANGE number number VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE crypto crypto VARCHAR(3) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE card_type CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
