 ...
 */
final class Version20220402225609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE advisor_schedule (id INT AUTO_INCREMENT NOT NULL, advisor_id INT NOT NULL, customer_id INT NOT NULL, date DATE NOT NULL, duration TIME NOT NULL, topic VARCHAR(255) NOT NULL, INDEX IDX_D8AE7BEC66D3AD77 (advisor_id), INDEX IDX_D8AE7BEC9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
