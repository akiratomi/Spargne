 ...
 */
final class Version20220402230055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advisor_schedule CHANGE date date DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE advisor_schedule CHANGE date date DATE NOT NULL, CHANGE topic topic VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
