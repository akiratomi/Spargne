 ...
 */
final class Version20220405185128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D8AE7BEC1F55203D ON advisor_schedule (topic_id)');
        $this->addSql('ALTER TABLE meeting_request ADD topic_id INT NOT NULL, DROP topic');
        ...
        $this->addSql('CREATE INDEX IDX_A345C7121F55203D ON meeting_request (topic_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D8AE7BEC1F55203D ON advisor_schedule');
        ...
        $this->addSql('DROP INDEX IDX_A345C7121F55203D ON meeting_request');
        $this->addSql('ALTER TABLE meeting_request ADD topic VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP topic_id');
        $this->addSql('ALTER TABLE meeting_topic CHANGE libelle libelle VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
